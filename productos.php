...
<head>
    ...
    <script src="funciones/eliminar_producto.js"></script>
...
<body>
    ...
    <button type="submit" class="boton_nuevo_producto" onclick="window.location.href='nuevo_producto.php'">Nuevo producto</button>
    ...
    <div class="container_filtro">
        <form id="form-filtros" class="form-filtros">
            <table class="tabla_listas_filtro">
                <thead>
                    <tr>
                        <th class="th_filtro" colspan="4">FILTRAR PRODUCTOS</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td class="td_filtro">
                            <div class="campo-formulario">
                                ...
                                <input type="text" placeholder="ID del producto" name="id_producto">
                            </div>
                        </td>
                        <td class="td_filtro">
                            <div class="campo-formulario">
                        ...
                        <td class="td_filtro">
                            <div class="campo-formulario">
                                ...
                                <input type="number" step="0.01" placeholder="Precio mínimo" min="0" name="precio_min_producto">
                            </div>
                        </td>
                        <td class="td_filtro">
                            <div class="campo-formulario">
                                <i class="fa-solid fa-money-bill-1-wave"></i>
                                <input type="number" step="0.01" placeholder="Precio máximo" min="0" name="precio_max_producto">
                            </div>
                        </td>
                    </tr>
                </tbody>
    ...
    <div id="resultados" class="container_productos">
        <!-- Resultados de productos se cargarán aquí con AJAX -->
    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            function filtrarProductos() {
                ...
                $.ajax({
                    type: "POST",
                    url: "funciones/filtrar_productos.php",
